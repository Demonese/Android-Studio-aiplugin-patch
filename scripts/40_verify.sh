...
echo "[1/14] 字节码校验 (CheckClassAdapter) ..."
for c in \
...
echo "[5/14] Chat Completions reasoning_content 回传测试 ..."
...
echo "[7/14] reasoningEffort 持久化测试 ..."
...
echo "[8/14] reasoning_effort/reasoning.effort 接入测试 ..."
...
echo "[10/14] 协议下拉控件运行时行为测试（headless）..."
...
echo "[11/14] 设置 -> computeState -> ModelApi 实例 端到端传播测试 ..."
...
echo "[12/14] WindowsShellResolver 单元测试 ..."
...
echo "[13/14] run_shell_command Windows 分支行为测试 ..."
...
echo "[14/14] Available Models 工具栏 \"+\" 按钮测试（headless）..."
